  ...
  return (
    <>
      ...
      >
        ...
        {isDropdownOpen && (
          <div className="absolute right-[2px] outline-none top-[38px] w-[325px] md:w-[230px] px-3 bg-gradient-to-r from-[#000F1D]  via-[#00182E] to-[#000F1D] h-[220px] z-[100] text-md font-[300]">
