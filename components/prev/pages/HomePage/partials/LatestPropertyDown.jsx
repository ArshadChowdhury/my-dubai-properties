...
//   // useEffect(() => {
//   //   animationRef.current = gsap.to(cardBoxRef.current, {
//   //     duration: 5,
//   //     ease: "none",
//   //     x: "+=500",
//   //     modifiers: {
...
//     duration: 1, // Increase for slower, decrease for faster (try 10-15)
//     ease: "none",
//     x: "+=5000", // Negative for left scroll, increase value for longer distance
//     modifiers: {
//       x: gsap.utils.unitize((x) => parseFloat(x) % 1000),
//     },
//     repeat: -1, // Already infinite
//   });
// }, []);
...
//           </div>
//           <div
//             className={`w-1/4 ${lang === "ar" ? "mr-auto ml-24" : "ml-auto mr-24"
//               } md:mr-[13rem]`}
//           >
//             <BtnElore2
//               route={
...
//           <div
//             className={`${isMobileView ? "lmb-flex" : "flex"
  ...
  return (
    <div className="w-full flex flex-row-reverse relative z-20">
      <div className="w-full md:basis-[95%] md:mt-12">
        ...
        <div className="md:ml-[205px] px-5 sm:pl-12 md:pl-20 lg:pl-28 xl:pl-32 2xl:pl-42 flex flex-col md:flex-row justify-between w-full md:pr-[155px]">
          <div className="mb-12 md:mb-0">
            <HomeHeading heading={props?.homeData?.lang?.slider?.titleReady || "Ready Properties"} />
          </div>
          <div className={`w-1/4 ${lang === "ar" ? "mr-auto ml-24" : "ml-auto mr-24"} md:mr-[13rem]`}>
            <BtnElore2
              route="properties/ready?developmentTypes=6519855e79fcdc27efbf85cd"
        ...
        <div className="block my-20 md:my-0 relative overflow-hidden md:left-[260px]">
          <div
            className={`${isMobileView ? "lmb-flex" : "flex"} my-5 px-1 py-8 gap-2`}
            ref={sliderRef}
          ...
          {/* Gradient Overlays */}
          <div className="hidden md:block w-16 h-[90%] absolute bottom-0 left-0 md:-ml-[100px] md:mb-[10px] overlay-property-color-left-2" />
          <div className="hidden md:block w-16 h-[90%] absolute bottom-0 left-0 md:-ml-1 md:mb-[50px] overlay-property-color-left-2" />
        </div>
      </div>
      ...
      <div className="hidden md:block w-16 h-[90%] absolute bottom-0 left-0 md:ml-[200px] md:mb-[15px] overlay-property-color-left" />
    </div>
  );
};
